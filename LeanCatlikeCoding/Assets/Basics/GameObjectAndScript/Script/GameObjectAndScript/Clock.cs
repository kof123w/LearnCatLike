...
public class Clock : MonoBehaviour
{
    ...
    private void Update()
    {
        var time = DateTime.Now;
         ...
         _hoursPivot.localRotation = Quaternion.Euler(new Vector3(0, 0,_hoursToDegrees * time.Hour));
         _minutesPivot.localRotation = Quaternion.Euler(new Vector3(0,0,_minutesToDegrees * time.Minute));
         _secondsPivot.localRotation = Quaternion.Euler(new Vector3(0,0,_secondsToDegrees * time.Second)); 
